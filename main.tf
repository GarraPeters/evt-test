module "security" {
  source = "${path.module}/services/security"
...
module "cert_manager" {
  source = "${path.module}/services/cert_manager"
...
module "dns" {
  source = "${path.module}/services/dns"
...
module "loadbalancer" {
  source = "${path.module}/services/loadbalancer"
...
module "cluster" {
  source = "${path.module}/services/cluster"
